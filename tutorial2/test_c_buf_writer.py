...
if __name__ == '__main__':
    ...
    ###########################################################################
    # ARRAY OF STRINGS
    # Look at how this answer:
        # https://stackoverflow.com/questions/4156992/passing-array-of-strings-as-parameter-in-python-ctypes
    # is different than this one (which is coded below)
    # https://stackoverflow.com/questions/41002121/python-ctypes-passing-an-array-of-strings
